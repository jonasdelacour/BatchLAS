...
Status: **Tiers 0, 1, 2 and 3 implemented; Tier 4 partially (§7.1, 7.2, 7.3, 7.4, 7.6, 7.7).**
...
### Tier 4 — partially done (§7.1, 7.2, 7.3, 7.4, 7.6, 7.7)
...
**Still open in §7:** 7.5 (locking/deflation),
