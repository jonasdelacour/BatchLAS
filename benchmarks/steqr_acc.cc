...
void run_steqr(miniacc::State& state) {
...
template <typename Real, Backend B>
static void ACC_STEQR(miniacc::State& state) {
    run_steqr<Real, B>(state);
}
...
BATCHLAS_REGISTER_ACCURACY(ACC_STEQR, EigensolverSizes)
