...
void run_syev_cta(miniacc::State& state, const char* impl_name) {
...
static void ACC_SYEV_CTA_PG(miniacc::State& state) {
    run_syev_cta<Real, B, SteqrUpdateScheme::PG>(state, "syev_cta_pg");
}

template <typename Real, Backend B>
static void ACC_SYEV_CTA_EXP(miniacc::State& state) {
    run_syev_cta<Real, B, SteqrUpdateScheme::EXP>(state, "syev_cta_exp");
}
...
BATCHLAS_REGISTER_ACCURACY(ACC_SYEV_CTA_PG, EigensolverSizes)
BATCHLAS_REGISTER_ACCURACY(ACC_SYEV_CTA_EXP, EigensolverSizes)
