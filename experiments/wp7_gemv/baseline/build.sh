#!/usr/bin/env bash
# Build the WP7 gemv baseline harness against the ALREADY-BUILT libraries in build/.
# Flags and link line copied from experiments/wp4_potrf/phase2_ab/build_real_v.sh.
set -euo pipefail
